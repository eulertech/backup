-- Transform script for Auto LV Sales... 

ALTER TABLE {schemaName}.alvsales_transposed ADD COLUMN dateConcept_temp VARCHAR(10);
ALTER TABLE {schemaName}.alvsales_transposed ADD COLUMN frequency VARCHAR(1);

UPDATE {schemaName}.alvsales_transposed 
...
ALTER TABLE {schemaName}.alvsales_transposed  DROP COLUMN dateConcept;
ALTER TABLE {schemaName}.alvsales_transposed  RENAME COLUMN dateConcept_temp TO dateConcept;